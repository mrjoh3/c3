...
```{r data, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
cat(
    capture_widget(c3(data, width = 800, height = 300),
...
```{r date, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
cat(
    capture_widget(c3(data, x = 'date', width = 800, height = 300),
                   'markdown', height=400, width=1100)
)
...
```{r pipe, eval = FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r spline, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r step, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
step.plot <- data %>%
  c3(x = 'date', width = 800, height = 300) %>%
  c3_line('area-step')
...
```{r bar, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r mixed, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r y2, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r y2.webshot, echo=FALSE, warning=FALSE, message=FALSE, comment=NA, results='asis'}
...
```{r scatter, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
scatter.plot <- iris %>%
  c3(x = 'Sepal_Length', y = 'Sepal_Width', group = 'Species', width = 800, height = 300) %>% 
  c3_scatter()
...
```{r pie, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r donut, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r donut.webshot, echo=FALSE, warning=FALSE, message=FALSE, comment=NA, results='asis', fig.align='center'}

donut.chart <- data.frame(red=82,green=33,blue=93) %>% 
  c3(colors=list(red='red',green='green',blue='blue'), width = 500, height = 300) %>% 
  c3_donut(title = '#d053ee')
...
```{r gauge, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r grid, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r region, eval = FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r subchart, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r brewer, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r viridis, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
...
```{r onclick, eval=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.width=4, fig.height=3}
